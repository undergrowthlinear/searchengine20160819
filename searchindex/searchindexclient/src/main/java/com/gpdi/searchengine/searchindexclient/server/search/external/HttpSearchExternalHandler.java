...
import com.gpdi.searchengine.searchindexclient.server.search.handler.SearchQueryHandler;
 ...
 * @version 1.0.0
 */
public class HttpSearchExternalHandler extends
		SimpleChannelInboundHandler<Object> {

	private Logger logger = LoggerFactory
			.getLogger(HttpSearchExternalHandler.class);
	...
	protected void channelRead0(ChannelHandlerContext ctx, Object msg) {
		if (msg instanceof HttpRequest) {
			...
			if (!params.isEmpty()) {
				...
				buf.append("\r\n");
				String searchResult = new SearchQueryHandler()
						.searchQuery(params);
