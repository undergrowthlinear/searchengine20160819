#!/bin/sh
#
# Start/Stop the searchindexclient server.
#
...
java -Dfile.encoding=utf8 ${JAVA_OPTS} -cp ${CLASSPATH} com.xuanwu.msggate.centrum.core.server.CentrumServer > ${SERVER_LOG} 2>&1 &
